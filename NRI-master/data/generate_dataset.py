...
parser.add_argument('--num-train', type=int, default=10000, #50000
                    help='Number of training simulations to generate.')
parser.add_argument('--num-valid', type=int, default=2000, #10000
                    help='Number of validation simulations to generate.')
parser.add_argument('--num-test', type=int, default=2000,  #10000
                    help='Number of test simulations to generate.')
parser.add_argument('--length', type=int, default=1000, #5000
                    help='Length of trajectory.')
parser.add_argument('--length-test', type=int, default=2000, #10000
